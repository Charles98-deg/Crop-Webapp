...
const ElasticMesh: React.FC<ElasticMeshProps> = ({
  ...
  useEffect(() => {
    ...
    function commit() {
      ...
      if (geometry.attributes.aOffset) geometry.attributes.aOffset.needsUpdate = true;
      if (geometry.attributes.aNormal) geometry.attributes.aNormal.needsUpdate = true;
    }
    ...
    return () => {
      ...
      if (gl.canvas instanceof HTMLElement && gl.canvas.parentElement === container) {
